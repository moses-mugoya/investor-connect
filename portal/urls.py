...
urlpatterns = [
    ...
    re_path(r'^search/biz/(?P<id>\d+)/$', views.biz_user_search, name='biz_search'),
    re_path(r'^search/(?P<id>\d+)/idea/$', views.idea_user_search, name='idea_search'),
    ...
    re_path(r'^(?P<id>\d+)/group/idea/$', views.group_chat_view_idea, name='group_idea'),
    ...
    re_path(r'^direct/business/investment/(?P<id>\d+)/$', views.direct_biz_invest, name='direct_biz_invest'),
    re_path(r'^direct/idea/investment/(?P<id>\d+)/$', views.direct_idea_invest, name='direct_idea_invest'),
    ...
    re_path(r'payment/service/(?P<id>\d+)/', views.pay_for_service, name='payment-service'),
    re_path(r'note/payment/(?P<id>\d+)/', views.pay_for_notes, name='payment-note'),
    ...
    re_path(r'^request-sent/$', views.request_sent, name='request_sent'),
    re_path(r'^cancel-subscription/$', views.cancel_subscription, name='cancel-subscription')
]
